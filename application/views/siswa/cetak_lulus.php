...
<body onload="window.print();">
  ...
  <center>
    <div style="border:1px solid black; color:green;width:30%;padding:10px;">
      <b style="font-size:20px;">D I T E R I M A</b>
    </div>
  </center>
  <br>

  SELEKSI Administrasi Sebagai Calon Anggota <?php echo $id['nama_lengkap']; ?> tahun <?php echo $thn_ppdb; ?>/<?php echo $thn_ppdb + 1; ?>.<br>
