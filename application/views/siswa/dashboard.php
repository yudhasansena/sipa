        ...
        <div class="col-lg-12">
          <?php if ($cek->status_pendaftaran == 'lulus') { ?>
            <div class="panel panel-success">
              ...
              <div class="panel-body">
                <h3>
                  <center>
                    Selamat <b><?php echo $nama; ?></b> <span class="label label-success" style="font-size:20px;">Lulus</span> Seleksi Sebagai Calon Anggota <b><?php echo $user['nama_lengkap']; ?></b>, Silahkan Cetak Surat Pengumuman Sebagai Bukti Lulus Seleksi.
                    <hr>
              ...
              <div class="panel-body" style="color:red">
                <h3>
                  <center>
                    ...
                    Sebagai Calon Anggota <b><?php echo $user['nama_lengkap']; ?></b>.
                  </center>
                  <br>
                </h3>
              </div>
          ...
          <?php } else { ?>
            <div class="panel panel-success">
              ...
              <div class="panel-body">
                <h3>
                  <left>Pendaftaran Anda Saat Ini Sedang Di Proses Oleh Administrasi <?php echo $user['nama_lengkap']; ?></left>
                </h3>
              </div>
            </div>
          <?php } ?>
