<div class="panel">
  <div class="panel-heading" style="background: #275555ff; color: honeydew;">
    <h2 align="center" style="margin-top: 10px;">FORM ISIAN<br><b>Data Asal Instansi</b> </h2>
    <!-- <hr> -->
  </div>
  <div class="panel-body">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9" style="margin-top:3px;">
        <select class="form-control bg-blue class" data-placeholder="Pilih Pekerjaan Ayah" name="pekerjaan_ayah" data-parsley-group="block3" data-parsley-errors-container='div[id="error-pekerjaan_ayah"]' required>
          ...
          ?>
            <option value="<?php //echo $baris->nama_pekerjaan; 
                            ?>"><?php //echo $baris->nama_pekerjaan; 
                                ?></option>
          <?php //endforeach; 
          ?>
        </select>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9" style="margin-top:3px;">
        <select class="form-control bg-blue class" data-placeholder="Pilih Penghasilan Ayah" name="penghasilan_ayah" data-parsley-group="block3" data-parsley-errors-container='div[id="error-penghasilan_ayah"]' required>
          ...
          ?>
            <option value="<?php //echo $baris->nama_penghasilan; 
                            ?>"><?php //echo $baris->nama_penghasilan; 
                                ?></option>
          <?php //endforeach; 
          ?>
        </select>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9" style="margin-top:3px;">
        <select class="form-control bg-blue class" data-placeholder="Pilih Pendidikan Ayah" name="pdd_ayah" data-parsley-group="block3" data-parsley-errors-container='div[id="error-pdd_ayah"]' required>
          ...
          ?>
            <option value="<?php //echo $baris->nama_pdd; 
                            ?>"><?php //echo $baris->nama_pdd; 
                                ?></option>
          <?php //endforeach; 
          ?>
        </select>
    ...
    <div class="form-group" style="padding-bottom:30px;">
      <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">Nama Instansi <span class="text-danger">*</span></label>
      <div class="col-sm-9 prepend-icon">
        <input type="text" name="nama_sekolah" class="form-control bg-blue" placeholder="Nama Sekolah/Universitas/Lembaga" maxlength="100" data-parsley-group="block4" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="error-nama_sekolah"]' required>
    ...
    <div class="form-group" style="padding-bottom:30px;">
      <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">Status Instansi <span class="text-danger">*</span></label>
      <div class="col-sm-9" style="margin-top:3px;">
        <select class="form-control bg-blue class" data-placeholder="Pilih status sekolah sebelumnya" name="status_sekolah" data-parsley-group="block4" data-parsley-errors-container='div[id="error-status_sekolah"]'>
          <option value="">Pilih Status Instansi</option>
    ...
    <div class="form-group" style="padding-bottom:30px;">
      <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">Lokasi Instansi <span class="text-danger">*</span></label>
      <div class="col-sm-9" style="margin-top:3px;">
