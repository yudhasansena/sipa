<div class="panel">
  <div class="panel-heading" style="background: #275555ff; color: honeydew;">
    <h2 align="center" style="margin-top: 10px;">FORM ISIAN<br><b>ALAMAT CALON ANGGOTA</b> </h2>
    <!-- <hr> -->
  </div>
  <div class="panel-body">
    ...
    <div class="form-group" style="padding-bottom:30px;">
      <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">Kelurahan/Desa <span class="text-danger">*</span></label>
      <div class="col-sm-9 prepend-icon">
    ...
    <div class="form-group" style="padding-bottom:30px;">
      <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">Kota/Kabupaten <span class="text-danger">*</span></label>
      <div class="col-sm-9 prepend-icon">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9" style="margin-top:3px;">
        <select class="form-control bg-blue class" data-placeholder="Jarak ke sekolah" name="jarak" data-parsley-group="block2" data-parsley-errors-container='div[id="error-jarak"]' required>
          <option value="">Pilih jarak anda ke perpustakaan kota Medan</option>
