...
<body id="page-top" class="index">
        ...
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">
                    ...
                    <span style="margin-left:45px;">&nbsp;SIPA PUSKOT MEDAN</span>
                </a>
            </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="intro-text">
                        <span class="name shad" style="font-size:35px; line-height: 35px;">
                            SELAMAT DATANG DI SISTEM INFORMASI PENDAFTARAN ANGGOTA <br> <?php echo $user['nama_lengkap']; ?>
                        </span>
                        <br>
                        ...
                        <?php } else { ?>
                            ...
                            <span>
                                <a href="javascript:void(0);" class="btn btn-danger btn-lg" style="margin:5px;"><i class="fa fa-file faa-pulse animated"></i> &nbsp;<b>PENDAFTARAN ANGGOTA PERPUSTAKAAN DITUTUP</b></a>
                                <br>
                            </span>
                        <?php } ?>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2>Alur Pendaftaran Anggota PUSKOT Medan</h2>
    ...
    <section class="success" id="about" style="padding: 30px; border-top: 2px solid #fff;">
        <div class="container">
            <div class=" row">
                <div class="col-lg-12 text-center">
                    <h2>Informasi SIPA PUSKOT Medan</h2>
                    <hr style="width: 150px;">
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-8 col-lg-offset-2 text-center page-scroll">
                    <a href="#page-top" class="btn btn-warning" style="border-radius: 5px;">
                        <i class="fa fa-home "></i> SIPA PUSKOT
                    </a> &nbsp;&nbsp;
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12" style="margin-top:-10px;">
                    <div class="col-md-2"></div>
                    <div class="col-md-8">
                        <h4 align="center">SIPA &copy; <?php echo $user['nama_lengkap']; ?><br><?php echo $user['alamat']; ?></h4>
    ...
    <footer class="text-center">
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        SIPA PUSKOT &copy; <?php echo $user['nama_lengkap']; ?> - <?php echo date('Y'); ?>
                    </div>
                </div>
            </div>
        </div>
