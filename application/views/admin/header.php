...
<head>
	...
	<title><?php echo $judul_web; ?> | SIPA PUSKOT Medan</title>
...
<body class="navbar-bottom">
	...
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<a class="navbar-brand" href="panel_admin/">SIPA <label class="label label-primary">PUSKOT MEDAN</label></a>
					...
					<div class="sidebar-category sidebar-category-visible">
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<!--<li class="<?php //if ($menu == 'panel_admin' and $sub_menu == 'data') {
												//echo 'active';
												//} 
												?>"><a href="panel_admin/data"><i class="icon-file-excel"></i> <span><b>EXPORT DATA</b></span></a></li> -->
