    ...
    <div class="row">
      ...
      <div class="panel panel-flat">
        <div class="panel-heading">
          ...
          <br>
          <a href="panel_admin/edit_materi" class="btn btn-danger"><b>LEMBAR PERMOHONAN</b></a>
          <a href="panel_admin/" class="btn btn-success btn-lg"><i class="icon-printer4"></i> <b>CETAK DATA</b></a>
          ...
          <table class="table datatable-basic table-sm table-striped" width="100%">
            <thead>
              <tr>
                ...
                <th>NIK</th>
                <th>Nama Lengkap</th>
                <th>Asal Sekolah/Univ/Instansi</th>
                <th>Asal Kota</th>
            ...
            <tbody>
              ...
              foreach ($v_siswa->result() as $baris) { ?>
                <tr>
                  ...
                  <td><?php echo $baris->kab; ?>, Prov. <?php echo $baris->prov; ?></td>
