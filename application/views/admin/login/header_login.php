...
<head>
	...
	<title>LOGIN SYSTEM | SIPA PUSKOT MEDAN</title>
...
<body class="navbar-bottom login-container">
	<!-- Main navbar -->
	<div class="navbar navbar-inverse" style="background-color: #275555ff;">
		<div class="navbar-header">
			<a class="navbar-brand" href=""><b>SIPA <label class="label label-success">PUSKOT MEDAN</b></label> </a>
		</div>
	</div>
	<!-- /main navbar -->
	<!-- Page container -->
